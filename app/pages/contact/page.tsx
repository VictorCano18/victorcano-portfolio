            ...
            <div className="text-white relative sm:max-w-full max-w-xs mx-auto">
                ...
                <div className='flex align-items-center justify-content-center gap-4 flex flex-col sm:flex-row'>
                    <div className="relative sm:w-1/2">
                        ...
                        <input type="text" id="input-group-1" className="bg-gray-50 border bg-transparent border-gray-600 placeholder-gray-100 text-white focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-100 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded" value="victor.cano.1806@gmail.com" disabled />
                    </div>
